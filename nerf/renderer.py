...
class NeRFRenderer(nn.Module):
    ...
    def run(self, rays_o, rays_d, gt=None, num_steps=128, upsample_steps=128, bg_color=None, perturb=False, **kwargs):
        ...
        # depth = torch.sum(ori_z_vals, dim=-1)
    ...
    def run_cuda(self, rays_o, rays_d, gt=None, dt_gamma=0, bg_color=None, perturb=False, force_all_rays=False, max_steps=1024, T_thresh=1e-4, **kwargs):
        # rays_o, rays_d: [B, N, 3], assumes B == 1
        # return: image: [B, N, 3], depth: [B, N]
    ...
    def render(self, rays_o, rays_d, gt=None, staged=False, max_ray_batch=4096, **kwargs):
        # rays_o, rays_d: [B, N, 3], assumes B == 1
        ...
        if staged and not self.cuda_ray:
            ...
            for b in range(B):
                ...
                while head < N:
                    ...
                    results_ = _run(rays_o[b:b+1, head:tail], rays_d[b:b+1, head:tail], gt, **kwargs)
            ...
            results = _run(rays_o, rays_d, gt, **kwargs)
